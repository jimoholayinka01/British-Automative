```{r}
#Web Scrapping for British Automobile
```
...
# Replace NA values in mileage and engine with the median
...
# MERGE BOTH DATASETS
clear_car_data <- bind_rows(car_data1, car_data2)
...
summary(clear_car_data)
#Count missing values
colSums(is.na(clear_car_data))

#PLot histograms for numeric variable

par(mfrow = c(2,2))
hist(clear_car_data$year, col = "skyblue", main = "Distribution of Car Year", xlab = "Year", breaks = 25)
hist(clear_car_data$mileage, col = "lightcoral", main = "Distribution of Mileage", xlab = "Mileage", breaks = 20)
hist(clear_car_data$engine, col = "lightgreen", main = "Distribution of Engine Power", xlab = "Engine Size", breaks = 15)
hist(clear_car_data$price, col = "gold", main = "Distribution of Car Price", xlab = "Price", breaks = 20)

#Get the top car brands
top_brands <- clear_car_data %>% count(brand, sort = TRUE) %>% head(10)
...
#Correlation matrix
numeric_vars <- clear_car_data %>% select(where(is.numeric))
...
par(mfrow = c(1,3))
boxplot(clear_car_data$year, main = "Boxplot of Car Year", col = "skyblue")
boxplot(clear_car_data$mileage, main = "Boxplot of Mileage", col = "lightcoral")
boxplot(clear_car_data$price, main = "Boxplot of Car Price", col = "gold")
```
